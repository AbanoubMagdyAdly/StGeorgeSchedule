                        ...
                        <form method="post" action="{{ route('room.update',$room->id) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" value="{{ $room->name }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('capacity') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="capacity" id="input-capacity" class="form-control form-control-alternative{{ $errors->has('capacity') ? ' is-invalid' : '' }}" placeholder="{{ __('capacity') }}" value="{{$room->capacity}}" step="5"required>
